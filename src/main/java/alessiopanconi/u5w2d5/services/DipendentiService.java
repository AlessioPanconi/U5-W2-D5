...
import alessiopanconi.u5w2d5.repositories.DipendenteRepository;
...
public class DipendentiService {
    ...
    public Dipendente saveDipendente(NewDipendenteDTO payload)
    {
        ...
        Dipendente newDipendente = new Dipendente(payload.username(),payload.nome(),payload.cognome(),payload.email(),avatarUrl);
